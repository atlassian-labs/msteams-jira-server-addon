...
public class ImageHelperImplTest {
    ...
    public void shouldReplaceFirstImageOccurrence() {
        ...
        PluginImageSettings pluginImageSettings = new PluginImageSettingsImpl();
        ...
        String result = new ImageHelperImpl(new ImageEncoderImpl(), pluginImageSettings)
    ...
    public void shouldReplaceFirstProjectAvatarsOccurrenceWhenAppropriateSetting() {
        ...
        assertEquals(1, replacedUrlsCount);
    }
